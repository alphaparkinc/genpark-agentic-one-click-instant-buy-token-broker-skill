# genpark-agentic-one-click-instant-buy-token-broker-skill
...
<p align="center">
  <b>Production-Grade Agent Commerce Skill</b> • <b>100% Standard Library Python</b> • <b>Native Model Context Protocol (MCP)</b>
</p>
...
**genpark-agentic-one-click-instant-buy-token-broker-skill** is a deterministic, zero-dependency Python skill engineered for autonomous AI agents, multi-agent frameworks (Claude Desktop, Cursor, AutoGPT, CrewAI), and enterprise e-commerce pipelines.

> **Executive Capability**: Agentic one-click instant buy token broker & headless settlement (Perplexity Buy)
...
```mermaid
graph LR
    User([🌐 User / Commerce Agent]) -->|JSON-RPC Request| MCP[⚡ MCP Server / CLI]
...
result = client.execute_instant_buy_transaction()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-agentic-one-click-instant-buy-token-broker-skill": {
      "command": "python",
      "args": ["/path/to/genpark-agentic-one-click-instant-buy-token-broker-skill/mcp_server.py"]
    }
  }
}
```
...
#### Q1: What makes GenPark AI Agent Commerce Skills unique?
...
Explore the comprehensive directory of 1,180+ open-source, production-ready AI Agent skills at the [GenPark AI MCP Hub](https://genpark.ai/mcp) and learn more about agentic shopping and commerce at [GenPark AI](https://genpark.ai).
